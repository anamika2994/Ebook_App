...
<head>
<meta charset="UTF-8">
<title>Children Books - Online Ebook Store</title>
...
<body style="background-color: #f5f5f5;">
    ...
    <div class="container-fluid p-5">
        <h2 class="section-title">🧒 Children Books</h2>
        <p class="text-center text-muted mb-5">Fun and educational books for young readers</p>
        ...
        <div class="row">
            ...
            try {
                ...
                List<BookDtls> list = dao.getChildrenBook();
                if (list.isEmpty()) {
            %>
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> No children books available at the moment.
                    </div>
                </div>
            <%
                } else {
